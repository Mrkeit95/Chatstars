...
export default function Page() {
  ...
  useEffect(() => {
    getBoards().then(b => {
      ...
      const match = all.find((board: any) => board.name.toLowerCase().includes("general"));
  ...
  if (!boardId) return (
    <div>
      <div className="mb-7"><h1 className="text-[26px] font-extrabold tracking-tight">General Manager</h1><p className="text-[13px] text-[#78716c] mt-1">Company-wide overview and management</p></div>
  ...
  return <MondayBoard boardId={boardId} title="General Manager" description="Company-wide overview and management" accentColor="#60a5fa" />;
}
