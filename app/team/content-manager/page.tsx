...
export default function Page() {
  ...
  useEffect(() => {
    getBoards().then(b => {
      ...
      const match = all.find((board: any) => board.name.toLowerCase().includes("content"));
  ...
  if (!boardId) return (
    <div>
      <div className="mb-7"><h1 className="text-[26px] font-extrabold tracking-tight">Content Manager</h1><p className="text-[13px] text-[#78716c] mt-1">Content planning, schedules, and approvals</p></div>
  ...
  return <MondayBoard boardId={boardId} title="Content Manager" description="Content planning, schedules, and approvals" accentColor="#f472b6" />;
}
