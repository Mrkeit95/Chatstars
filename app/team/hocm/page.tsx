...
export default function Page() {
  ...
  useEffect(() => {
    getBoards().then(b => {
      ...
      const match = all.find((board: any) => board.name.toLowerCase().includes("hocm"));
  ...
  if (!boardId) return (
    <div>
      <div className="mb-7"><h1 className="text-[26px] font-extrabold tracking-tight">HOCM</h1><p className="text-[13px] text-[#78716c] mt-1">Head of Chat Management dashboard</p></div>
  ...
  return <MondayBoard boardId={boardId} title="HOCM" description="Head of Chat Management dashboard" accentColor="#4ade80" />;
}
