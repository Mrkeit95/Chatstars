...
export default function Page() {
  ...
  useEffect(() => {
    getBoards().then(b => {
      ...
      const match = all.find((board: any) => board.name.toLowerCase().includes("account"));
  ...
  if (!boardId) return (
    <div>
      <div className="mb-7"><h1 className="text-[26px] font-extrabold tracking-tight">Account Executive</h1><p className="text-[13px] text-[#78716c] mt-1">Client accounts, deals, and partnerships</p></div>
  ...
  return <MondayBoard boardId={boardId} title="Account Executive" description="Client accounts, deals, and partnerships" accentColor="#facc15" />;
}
