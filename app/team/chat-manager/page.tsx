...
export default function Page() {
  ...
  useEffect(() => {
    getBoards().then(b => {
      ...
      const match = all.find((board: any) => board.name.toLowerCase().includes("chat"));
  ...
  if (!boardId) return (
    <div>
      <div className="mb-7"><h1 className="text-[26px] font-extrabold tracking-tight">Chat Manager</h1><p className="text-[13px] text-[#78716c] mt-1">Chat management team, schedules, and performance</p></div>
  ...
  return <MondayBoard boardId={boardId} title="Chat Manager" description="Chat management team, schedules, and performance" accentColor="#4ade80" />;
}
