...
export default function Dashboard() {
  ...
  return (
    <>
      <div className="mb-7"><h1 className="text-[26px] font-extrabold tracking-tight">Dashboard</h1><p className="text-[13px] text-[#78716c] mt-1">March 2026 · Stellar OPS</p></div>
